...
public class JhipsterSampleAppAngularJsApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleAppAngularJsApp.class);

    private final Environment env;

    public JhipsterSampleAppAngularJsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleAppAngularJS.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleAppAngularJsApp.class);
